...
<body>
	<form action="drop_deposit.php"  method="post">
	<table width='50%' border = 1 cellpadding="3" cellspacing="3">
		<tr><td> </td><td>Название депозита </td><td> Минимальное кол-во дней</td><td>Минимальная сумма </td><td> Название валюты</td><td> Процентная ставка</td></tr>
	<?php
